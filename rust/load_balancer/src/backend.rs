...
#[async_trait]
pub trait Backend: Send + Sync + Debug + BackendClone {
    ...
    ///
    /// TODO: You should add arguments to this function to pass the request method, headers, body,
    /// etc.
    ...
    /// Returns the address of the backend server.
    fn address(&self) -> &str;
}
